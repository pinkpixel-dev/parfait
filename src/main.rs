...
const APP_ID: &str = "dev.pinkpixel.Parfait";
...
fn main() -> glib::ExitCode {
    ...
    // gio::resources_register_include!("parfait.gresource")
...
fn build_ui(app: &adw::Application) {
    ...
    let window = window::ParfaitWindow::new(app);
...
fn setup_window_actions(window: &window::ParfaitWindow) {
    // Open action
