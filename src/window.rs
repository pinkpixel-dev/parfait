...
mod imp {
    ...
    impl ObjectSubclass for ParfaitWindow {
        const NAME: &'static str = "ParfaitWindow";
        type Type = super::ParfaitWindow;
    ...
    impl ObjectImpl for ParfaitWindow {
        fn constructed(&self) {
            ...
            // Set up the window
            obj.set_title(Some("Parfait"));
            obj.set_default_size(900, 650);

            // Create empty state status page
            const LOGO_BYTES: &[u8] = include_bytes!("../data/icons/dev.pinkpixel.Parfait.png");
            ...
            self.status_page.set_title("Welcome to Parfait");
            self.status_page
            ...
            menu.append(Some("_About Parfait"), Some("app.about"));
    ...
    impl WidgetImpl for ParfaitWindow {}
    impl WindowImpl for ParfaitWindow {}
    impl ApplicationWindowImpl for ParfaitWindow {}
    impl AdwApplicationWindowImpl for ParfaitWindow {}

    impl ParfaitWindow {
        fn setup_drag_drop(&self, window: &super::ParfaitWindow) {
            let drop_target =
...
glib::wrapper! {
    pub struct ParfaitWindow(ObjectSubclass<imp::ParfaitWindow>)
